        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                    ...
                    <span
                        class="self-center text-xl font-semibold text-white sm:text-2xl whitespace-nowrap">Klinikku</span>
                </a>
            </div>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ url('/admin/pasien') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Akun Pasien</span>
                </a>
            </li>
            <li>
                <a href="{{ url('/admin/dokter') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Akun Dokter</span>
                </a>
            </li>
            <li>
...
{{-- <script>
    ...
    dropdownUserButton.addEventListener('click', () => {
        dropdownUser.classList.toggle('hidden');
    });

    document.addEventListener('click', (event) => {
        if (!dropdownUserButton.contains(event.target) && !dropdownUser.contains(event.target)) {
