@if (session()->has('success'))
    <div id="alert-3"
        class="flex items-center p-4 mb-4 text-green-800 bg-green-100 rounded-lg dark:bg-gray-800 dark:text-green-400"
        role="alert">
        ...
        <button type="button"
            ...
            onclick="$('#alert-3').fadeOut()" aria-label="Close">
