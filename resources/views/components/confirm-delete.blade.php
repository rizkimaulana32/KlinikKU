<div id="deleteModal{{ $itemId }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full h-full max-w-md p-4 md:h-auto">
        <!-- Modal content -->
        <div class="relative p-4 text-center bg-gray-100 rounded-lg shadow-md dark:bg-gray-800 sm:p-5">
            <button type="button"
                class="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                onclick="toggleModal('deleteModal{{ $itemId }}')">
            ...
            <div class="flex items-center justify-center space-x-4">
                <button onclick="toggleModal('deleteModal{{ $itemId }}')" type="button"
