                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @foreach ($data as $user)
                                <tr>
                                    ...
                                    @if ($user->dokter)
                                        <td class="max-w-xs px-6 py-4 truncate">{{ $user->dokter->name }}</td>
                                        <td class="max-w-xs px-6 py-4 truncate">{{ $user->dokter->spesialis }}</td>
                                        <td class="max-w-xs px-6 py-4 truncate">{{ $user->dokter->gender }}</td>
                                        <td class="max-w-xs px-6 py-4 truncate">{{ $user->dokter->age }}</td>
                                        <td class="max-w-xs px-6 py-4 truncate">{{ $user->dokter->phone }}</td>
                                    @else
                                        <td class="max-w-xs px-6 py-4 truncate" colspan="5"></td>
                                    @endif
