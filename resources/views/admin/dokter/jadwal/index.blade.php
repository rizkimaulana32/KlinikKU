        ...
        <div class="pt-8 mt-8 bg-white">
            <div class="container max-w-full mx-auto">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <h2 class="flex-1 text-2xl font-bold text-center text-gray-900">Schedule Table</h2>
                ...
                <div class="flex flex-col mt-4 mb-4 sm:flex-row sm:justify-between">
                    <div class="flex items-center mb-2 sm:mb-0">
                        <form action="{{ url('/admin/dokter/' . $dokter_id . '/jadwal') }}" method="GET"
                        ...
                        <a href="{{ url('admin/dokter/' . $dokter_id . '/jadwal') }}"
                    ...
                    <div class="flex justify-center mt-2 sm:mt-0 sm:justify-end ml-2.5">
                        <a href="{{ url('/admin/dokter/' . $dokter_id . '/jadwal/create') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-left">
                                        <div class="flex items-center">
                                            <a href="{{ url('/admin/dokter/' . $dokter_id . '/jadwal/' . $jadwal->id . '/edit') }}"
                                                class="mr-4 text-indigo-600 hover:text-indigo-900">Update</a>
                                            <form
                                                action="{{ url('/admin/dokter/' . $dokter_id . '/jadwal/' . $jadwal->id) }}"
