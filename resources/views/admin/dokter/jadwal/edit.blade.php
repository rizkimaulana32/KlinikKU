...
@section('content')
    <section class="p-4 bg-white dark:bg-gray-900 sm:ml-64">
        <div class="max-w-3xl px-4 py-8 mx-auto md:py-16">
            ...
            <form action="{{ url('/admin/dokter/' . $dokter_id . '/jadwal/' . $data->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="flex justify-between mt-6">
                    ...
                    <button type="submit"
                        class="items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-primary-200 hover:bg-primary-800">
                        Update Schedule
                    </button>
                </div>
            </form>
