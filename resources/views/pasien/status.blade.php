...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="index.html">KLINIKU</a></h1>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <a href="index.html" class="logo me-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

            <nav id="navbar" class="order-last navbar order-lg-0">
                <ul>
                    <li><a class="nav-link scrollto" href="/homepasien">Home</a></li>
                ...
                <div class="row">
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            ...
                            <p>
                                Kami menyediakan akses cepat dan mudah dalam layanan kesehatan seperti pendaftaran pasien online, 
                                pengelolaan jadwal dokter yang fleksibel, akses cepat ke rekam medis, dan kemampuan untuk
                        ...
                        <div class="col-lg-6">
                            <div class="member d-flex align-items-start">
                                ...
                                <div class="member-info">
                                    ...
                                    <div>
                                        <button class="btn btn-primary btn-custom me-3">Jadwal Dokter</button>
                                        <button class="btn btn-secondary btn-custom">Buat Janji</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-4 row">
                        <div class="text-center col-md-6">
                            <p class="status-badge"><strong>Status:</strong> <span
                                    class="badge bg-success">Dikonfirmasi</span>
                            </p>
                        </div>
                        <div class="text-center col-md-6">
